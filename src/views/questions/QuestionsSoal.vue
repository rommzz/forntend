    ...
    <v-card>
      ...
      <template v-if="data.soal.length">
        ...
        >
          ...
          <v-list-item>
            <v-list-item-content>
              <v-list-item-title>Matpel</v-list-item-title>
        ...
        <v-card-text>
          <div>
            <span>Judul: </span><span class="text-capitalize">{{ data.judul }}</span>
          </div>
          <div>
            <span>Matpel: </span><span class="text-capitalize">{{ data.matpel }}</span>
          </div>
        </v-card-text>
        <v-simple-table>
          <thead>
